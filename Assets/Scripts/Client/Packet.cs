...
namespace Assets.Scripts.Client
{
    public sealed class Packet : IDisposable
    {
        ...
        public Vector2 GetVector2(bool peek = false) => new(GetFloat(peek), GetFloat(peek));
        public long GetLong(bool peek = false) => BitConverter.ToInt64(TakeDataSlice(8, peek));
        public DateTime GetUtcDateTime(bool peek = false) => DateTimeOffset.FromUnixTimeMilliseconds(GetLong(peek)).UtcDateTime;
